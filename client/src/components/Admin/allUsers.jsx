...
import "../../style/allUsersStyle.css"; // ייבוא קובץ CSS מותאם אישית
            ...
            <div className="page-container">
                                ...
                                <td>
                                    <div className="user-actions-row">
                                        <MessageBox
                                            ...
                                            onChange={(val) =>
                                                setUserMessages((prev) => ({ ...prev, [u.id]: val }))
                                            }
                ...
                {!loading && users.length < total && (
                    <div style={{ marginTop: "1rem" }}>
                        <button className="load" onClick={handleLoadMore}>טען עוד משתמשים</button>
                    </div>
                )}
